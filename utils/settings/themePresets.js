...
export function getThemePreset(_0x317eb4) {
  return themePresets[_0x317eb4] || null;
}
export function isLightTheme(_0x2f8a80) {
  const _0x4abb11 = ["默认-白天", "樱花粉", "森林绿", "薰衣草", "琥珀橙", "莫兰迪", "冰川蓝", "暖沙棕", "纯净白"];
  return _0x4abb11.includes(_0x2f8a80);
}